...
do
    echo "python main.py  --arch=$model  --save-dir=save_$model  --dropout=0.0  --feature-dir=feature_$model -gpu  --seed=0 |& tee -a log_$model"
    python main.py  --arch=$model  --save-dir=save_$model  --dropout=0.0  --feature-dir=feature_$model  -gpu  --seed=0 |& tee -a log_$model
done
